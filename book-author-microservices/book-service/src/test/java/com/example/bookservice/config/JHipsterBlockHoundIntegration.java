...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.example.bookservice.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.example.bookservice.security.DomainUserDetailsService", "createSpringSecurityUser");
