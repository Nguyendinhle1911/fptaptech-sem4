...
class ProductResourceIT {
    ...
    public static Product createEntity() {
        return new Product().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).price(DEFAULT_PRICE).stockQuantity(DEFAULT_STOCK_QUANTITY);
    }
    ...
    public static Product createUpdatedEntity() {
        return new Product().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE).stockQuantity(UPDATED_STOCK_QUANTITY);
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE).stockQuantity(UPDATED_STOCK_QUANTITY);
