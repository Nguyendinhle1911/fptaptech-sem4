            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.order.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('orderDate')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.order.orderDate">Order Date</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('orderDate')} />
                </th>
                <th className="hand" onClick={sort('status')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.order.status">Status</Translate>{' '}
                ...
                <th>
                  <Translate contentKey="jhipsterSampleApplicationApp.order.customer">Customer</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {orderList.map((order, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`jhipsterSampleApplicationApp.OrderStatus.${order.status}`} />
                  </td>
