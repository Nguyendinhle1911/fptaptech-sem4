...
export const OrderDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.order.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.order.delete.question" interpolate={{ id: orderEntity.id }}>
