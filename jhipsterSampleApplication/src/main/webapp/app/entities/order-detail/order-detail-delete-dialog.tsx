...
import { deleteEntity, getEntity } from './order-detail.reducer';
...
export const OrderDetailDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.orderDetail.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.orderDetail.delete.question" interpolate={{ id: orderDetailEntity.id }}>
